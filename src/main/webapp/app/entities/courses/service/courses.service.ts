...
export class CoursesService {
  ...
  update(courses: ICourses): Observable<EntityResponseType> {
    return this.http.put<ICourses>(`${this.resourceUrl}/${getCoursesIdentifier(courses) as number}`, courses, { observe: 'response' });
  }

  partialUpdate(courses: ICourses): Observable<EntityResponseType> {
    return this.http.patch<ICourses>(`${this.resourceUrl}/${getCoursesIdentifier(courses) as number}`, courses, { observe: 'response' });
  }
