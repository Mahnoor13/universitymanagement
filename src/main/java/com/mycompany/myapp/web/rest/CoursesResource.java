...
public class CoursesResource {
    ...
    public ResponseEntity<Courses> partialUpdateCourses(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, courses.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/courses")
    public ResponseEntity<List<Courses>> getAllCourses(Pageable pageable) {
    ...
    public ResponseEntity<Courses> createCourse(@RequestBody Courses courses ){
        return ResponseEntity
            .ok()
            .body(coursesService.create(courses));
