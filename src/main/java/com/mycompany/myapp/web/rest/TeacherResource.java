...
public class TeacherResource {
    ...
    public TeacherResource(TeacherService teacherService, TeacherRepository teacherRepository, UserMapper userMapper, UserService userService) {
    ...
    public ResponseEntity<Teacher> createTeacher(@RequestBody TeacherDto teacherDto){
        AdminUserDTO adminUserDTO = userMapper.toAdminUserDto(teacherDto);
        User user = userService.createUserForTeacher(adminUserDTO,teacherDto.getPassword());
        Teacher teacher = teacherService.createTeacher(user,teacherDto.getPhone());
