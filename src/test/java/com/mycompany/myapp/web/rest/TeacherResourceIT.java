...
class TeacherResourceIT {
    ...
    public static Teacher createEntity(EntityManager em) {
        Teacher teacher = new Teacher().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).phone(DEFAULT_PHONE);
        return teacher;
    }
    ...
    public static Teacher createUpdatedEntity(EntityManager em) {
        Teacher teacher = new Teacher().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE);
        return teacher;
    }
    ...
    void putNewTeacher() throws Exception {
        ...
        updatedTeacher.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE);
    ...
    void partialUpdateTeacherWithPatch() throws Exception {
        ...
        partialUpdatedTeacher.firstName(UPDATED_FIRST_NAME).phone(UPDATED_PHONE);
    ...
    void fullUpdateTeacherWithPatch() throws Exception {
        ...
        partialUpdatedTeacher.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE);
